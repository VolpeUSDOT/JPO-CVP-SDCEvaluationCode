...
INSERT INTO NYCDB.dbo.VolpeDA_BSW
...
(	SELECT a.VolpeID, a.EventID, a.WarningStartTime, a.WarningType, a.Control, a.Active, a.VehClass, a.TimeBin, a.WeatherCond, 
	...
	, CASE WHEN a.LatGap > 0 AND a.RV_LanePosition = 1  AND ABS(a.DeltaElevation) <= 10 AND RV_OppositeDirection = 0 
