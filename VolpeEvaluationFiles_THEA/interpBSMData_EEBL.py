...
eventTableName = 'thea_warningeebl_core'
...
eventRecords.drop(columns=['eeblid', 'level_0', 'index'], inplace=True)
...
eventRecords.to_sql(name='Volpe_warningEEBL_unique', con=MSSQLEngine, if_exists='append')    

#columnToPlot = 'coredataspeed'
