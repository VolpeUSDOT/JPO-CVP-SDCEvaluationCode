...
eventTableName = 'thea_warningwwe_core'
...
eventRecords.drop_duplicates(subset=['metadataloggeneratedat', 'hvbsmid', 'hvbsmlat', 'hvbsmlong'], inplace=True)
...
eventRecords.drop(columns=['wweid', 'level_0', 'index'], inplace=True)
...
eventRecords.to_sql(name='Volpe_warningWWE_unique', con=MSSQLEngine, if_exists='append') 
