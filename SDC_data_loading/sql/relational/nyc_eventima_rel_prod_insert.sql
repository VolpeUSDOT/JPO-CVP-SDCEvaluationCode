...
-- nyc_eventima_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventima_core(
    EVENTID string,
...
DROP TABLE IF EXISTS nyc_eventima_tmp;

CREATE TABLE nyc_eventima_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventima_staging;

INSERT INTO TABLE nyc_eventima_core
SELECT
    EVENTID AS EVENTID,
