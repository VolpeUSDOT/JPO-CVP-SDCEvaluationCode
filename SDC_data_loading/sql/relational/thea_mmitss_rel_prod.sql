----------------------------------------------------------------------------------------------------
-- Create the following relational tables from thea_mmitss table:
...
CREATE TABLE thea_mmitss_tmp 
	...
	AS SELECT reflect("java.util.UUID", "randomUUID") mmitssid, *
		 FROM thea_mmitss;
--------------------------------------------------
-- thea_mmitss_metadata
--------------------------------------------------
DROP TABLE IF EXISTS thea_mmitss_metadata;

CREATE TABLE thea_mmitss_metadata 
	STORED AS ORC tblproperties ("orc.compress" = "Zlib")
	AS SELECT 
		mmitssid,
...
-- thea_mmitss_queuelen
--------------------------------------------------
DROP TABLE IF EXISTS thea_mmitss_queuelen;

CREATE TABLE thea_mmitss_queuelen 
	STORED AS ORC tblproperties ("orc.compress" = "Zlib")
	AS SELECT 
        mmitssid,
...
-- thea_mmitss_trafperf
--------------------------------------------------
DROP TABLE IF EXISTS thea_mmitss_trafperf;

CREATE TABLE thea_mmitss_trafperf 
	STORED AS ORC tblproperties ("orc.compress" = "Zlib")
	AS SELECT 
        mmitssid,
		t.delay       as delay,
