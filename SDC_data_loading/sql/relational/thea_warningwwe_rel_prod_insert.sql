...
-- thea_warningwwe_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS thea_warningwwe_core(
    wweid string,
...
--------------------------------------------------
DROP TABLE thea_warningwwe_tmp;

CREATE TABLE thea_warningwwe_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    reflect("java.util.UUID", "randomUUID") wweid, 
    * 
FROM thea_warningwwe_staging;

INSERT INTO TABLE thea_warningwwe_core
SELECT
    wweid,
    ...
    PAYLOAD AS PAYLOAD
FROM thea_warningwwe_tmp;

--DROP temperary tables. 

DROP TABLE IF EXISTS thea_warningwwe_tmp;
