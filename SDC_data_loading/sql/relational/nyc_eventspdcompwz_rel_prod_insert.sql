...
-- Relational tables 
--   nyc_eventspdcompwz_core
----------------------------------------------------------------------------------------------------

--------------------------------------------------
-- nyc_eventspdcompwz_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventspdcompwz_core(
    EVENTID string,
    ...
    EVENTHEADERPARAMETERSEXCESSIVEZONESPD string,
    EVENTHEADERPARAMETERSEXCESSIVEZONESPDTIME string,
...
DROP TABLE IF EXISTS nyc_eventspdcompwz_tmp;

CREATE TABLE nyc_eventspdcompwz_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventspdcompwz_staging;

INSERT INTO TABLE nyc_eventspdcompwz_core
SELECT
    EVENTID AS EVENTID,
    ...
    EVENTHEADER.PARAMETERS.EXCESSIVEZONESPD AS EVENTHEADERPARAMETERSEXCESSIVEZONESPD,
    EVENTHEADER.PARAMETERS.EXCESSIVEZONESPDTIME AS EVENTHEADERPARAMETERSEXCESSIVEZONESPDTIME,
