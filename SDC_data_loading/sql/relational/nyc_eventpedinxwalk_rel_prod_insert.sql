...
-- Relational tables 
--   nyc_eventpedinxwalk_core
----------------------------------------------------------------------------------------------------

--------------------------------------------------
-- nyc_eventpedinxwalk_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventpedinxwalk_core(
    EVENTID string,
...
DROP TABLE IF EXISTS nyc_eventpedinxwalk_tmp;

CREATE TABLE nyc_eventpedinxwalk_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventpedinxwalk_staging;

INSERT INTO TABLE nyc_eventpedinxwalk_core
SELECT
    EVENTID AS EVENTID,
