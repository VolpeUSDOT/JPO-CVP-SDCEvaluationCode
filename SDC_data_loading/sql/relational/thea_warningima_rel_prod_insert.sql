...
-- This script inserts relational data into relational tables from thea_warningima_staging table (which has nested JSON data).
...
-- thea_warningima_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS thea_warningima_core(
    imaid string,
...
--------------------------------------------------
DROP TABLE IF EXISTS thea_warningima_tmp;

CREATE TABLE thea_warningima_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    reflect("java.util.UUID", "randomUUID") imaid, 
    * 
FROM thea_warningima_staging;

INSERT INTO TABLE thea_warningima_core
SELECT
    imaid,
