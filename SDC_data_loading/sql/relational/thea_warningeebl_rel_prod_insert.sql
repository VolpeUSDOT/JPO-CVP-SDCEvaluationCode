...
-- thea_warningeebl_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS thea_warningeebl_core(
    eeblid string,
...
DROP TABLE IF EXISTS thea_warningeebl_tmp;

CREATE TABLE thea_warningeebl_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    reflect("java.util.UUID", "randomUUID") eeblid, 
    * 
FROM thea_warningeebl_staging;

INSERT INTO TABLE thea_warningeebl_core
SELECT
    eeblid,
