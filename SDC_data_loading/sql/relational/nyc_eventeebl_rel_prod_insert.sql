...
-- nyc_eventeebl_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventeebl_core(
    EVENTID string,
...
DROP TABLE IF EXISTS nyc_eventeebl_tmp;

CREATE TABLE nyc_eventeebl_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventeebl_staging;

INSERT INTO TABLE nyc_eventeebl_core
SELECT
    EVENTID AS EVENTID,
