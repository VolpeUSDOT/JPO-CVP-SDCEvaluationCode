----------------------------------------------------------------------------------------------------
-- This script inserts relational data into relational tables from thea_warningfcw_staging table (which has nested JSON data).
...
-- thea_warningfcw_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS thea_warningfcw_core(
    fcwid string,
...
AS SELECT 
    reflect("java.util.UUID", "randomUUID") fcwid, 
    * 
FROM thea_warningfcw_staging;

INSERT INTO TABLE thea_warningfcw_core
SELECT
    fcwid,
