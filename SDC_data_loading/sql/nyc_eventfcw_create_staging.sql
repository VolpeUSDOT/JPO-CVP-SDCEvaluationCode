--------------------------------------------------------------
-- Create the NYC_EVENTFCW_STAGING table 
--------------------------------------------------------------
DROP TABLE IF EXISTS nyc_eventfcw_staging;

CREATE EXTERNAL TABLE IF NOT EXISTS nyc_eventfcw_staging(
  eventheader struct<
...
LOCATION 
's3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventFCW/';
--'s3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventFCW/';

CREATE TABLE IF NOT EXISTS nyc_eventfcw(
  eventheader struct<
    locationsource:string,
    asdfirmwareversion:string,
    eventalertactive:boolean,
