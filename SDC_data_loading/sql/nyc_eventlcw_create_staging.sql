--------------------------------------------------------------
-- Create the NYC_EVENTLCW_STAGING table 
--------------------------------------------------------------
DROP TABLE IF EXISTS nyc_eventlcw_staging;

CREATE EXTERNAL TABLE IF NOT EXISTS nyc_eventlcw_staging(
  eventheader struct<
...
LOCATION 
's3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventLCW/';
--'s3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventLCW/';

CREATE TABLE IF NOT EXISTS nyc_eventlcw(
  eventheader struct<
    locationsource:string,
    asdfirmwareversion:string,
    eventalertactive:boolean,
