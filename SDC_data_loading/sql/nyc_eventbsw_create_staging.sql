--------------------------------------------------------------
-- Create the NYC_EVENTBSW_STAGING table 
--------------------------------------------------------------
DROP TABLE IF EXISTS nyc_eventbsw_staging;

CREATE EXTERNAL TABLE IF NOT EXISTS nyc_eventbsw_staging(
  eventheader struct<
...
LOCATION 
's3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventBSW/';
--'s3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventBSW/';

CREATE TABLE IF NOT EXISTS nyc_eventbsw(
  eventheader struct<
    locationsource:string,
    asdfirmwareversion:string,
    eventalertactive:boolean,
