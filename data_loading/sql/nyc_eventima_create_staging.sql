--------------------------------------------------------------
-- Create the NYC_EVENTIMA_STAGING table 
--------------------------------------------------------------
DROP TABLE IF EXISTS nyc_eventima_staging;

CREATE EXTERNAL TABLE IF NOT EXISTS nyc_eventima_staging(
  eventheader struct<
...
LOCATION 
's3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventIMA/';
--'s3a://DOT-SDC-CVP-STAGING-S3-BUCKET-NAME/cv/nyc/eventIMA/';

CREATE TABLE IF NOT EXISTS nyc_eventima(
  eventheader struct<
    locationsource:string,
    asdfirmwareversion:string,
    eventalertactive:boolean,
