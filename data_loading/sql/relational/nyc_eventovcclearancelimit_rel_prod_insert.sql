...
-- Relational tables 
--   nyc_eventovcclearancelimit_core
----------------------------------------------------------------------------------------------------

--------------------------------------------------
-- nyc_eventovcclearancelimit_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventovcclearancelimit_core(
    EVENTID string,
    ...
    EVENTHEADERPARAMETERSPOSTEDHEIGHTLIMIT string,
    EVENTHEADERPARAMETERSPOSTEDSIZELIMIT string,
...
DROP TABLE IF EXISTS nyc_eventovcclearancelimit_tmp;

CREATE TABLE nyc_eventovcclearancelimit_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventovcclearancelimit_staging;

INSERT INTO TABLE nyc_eventovcclearancelimit_core
SELECT
    EVENTID AS EVENTID,
    ...
    EVENTHEADER.PARAMETERS.POSTEDHEIGHTLIMIT AS EVENTHEADERPARAMETERSPOSTEDHEIGHTLIMIT,
    EVENTHEADER.PARAMETERS.POSTEDSIZELIMIT AS EVENTHEADERPARAMETERSPOSTEDSIZELIMIT,
...
FROM nyc_eventovcclearancelimit_tmp;
