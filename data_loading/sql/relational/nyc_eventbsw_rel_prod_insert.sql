...
-- nyc_eventbsw_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventbsw_core(
    EVENTID string,
...
DROP TABLE IF EXISTS nyc_eventbsw_tmp;

CREATE TABLE nyc_eventbsw_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventbsw_staging;

INSERT INTO TABLE nyc_eventbsw_core
SELECT
    EVENTID AS EVENTID,
