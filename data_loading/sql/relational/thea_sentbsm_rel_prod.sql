----------------------------------------------------------------------------------------------------
-- This script creates relational tables from thea_sentbsm (which has nested JSON data).
...
CREATE TABLE thea_sentbsm_tmp 
    ...
    AS SELECT 
        reflect("java.util.UUID", "randomUUID") bsmid, * FROM thea_sentbsm;

--------------------------------------------------
-- thea_sentbsm_core
--------------------------------------------------
DROP TABLE IF EXISTS thea_sentbsm_core;
CREATE TABLE thea_sentbsm_core 
    STORED AS ORC tblproperties ("orc.compress" = "Zlib")
    AS SELECT 
        bsmid,
...
--------------------------------------------------
-- thea_sentbsm_partii (SUPPLEMENTALVEHICLEEXTENSIONS) 
--------------------------------------------------
DROP TABLE IF EXISTS thea_sentbsm_partii;

CREATE TABLE thea_sentbsm_partii 
    STORED AS ORC tblproperties ("orc.compress" = "Zlib")
    AS SELECT 
        partiiid,
        bsmid,
...
--------------------------------------------------
-- thea_sentbsm_partii_crumbdata (VEHICLESAFETYEXTENSIONS) 
--------------------------------------------------
DROP TABLE IF EXISTS thea_sentbsm_partii_crumbdata;
CREATE TABLE thea_sentbsm_partii_crumbdata 
    STORED AS ORC tblproperties ("orc.compress" = "Zlib")
    AS SELECT 
        partiiid,
        bsmid,
