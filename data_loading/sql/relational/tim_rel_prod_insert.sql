--INSERT of WYDOT TIM V6 data into relational tables

------------------------------------------------------------------------
-- Create wydot_tim_tmp from wydot_tim_staging_v6
------------------------------------------------------------------------
...
INSERT INTO TABLE wydot_tim_metadata
	...
	FROM wydot_tim_tmp;
------------------------------------------------------------------------
-- Insert into wydot_tim_snmp from wydot_tim_tmp 
------------------------------------------------------------------------
INSERT INTO TABLE wydot_tim_snmp
	SELECT	timid,
...
------------------------------------------------------------------------
-- Insert into wydot_tim_broadcast from wydot_tim_tmp
------------------------------------------------------------------------
INSERT INTO TABLE wydot_tim_broadcast
	SELECT	timid,
...
------------------------------------------------------------------------
-- Insert into wydot_tim_rsus from wydot_tim_tmp 
------------------------------------------------------------------------
INSERT INTO TABLE wydot_tim_rsus
	select  t.timid,
...
INSERT INTO TABLE wydot_tim_payload
	SELECT	timid,
			...
			--payload.data.MessageFrame.value.TravelerInformation.dataFrames.TravelerDataFrame.frameType.commercialSignage         as payloadDataFramesFrameTypeCommericalSignage,
