...
-- Relational tables 
--   nyc_eventspdcomp_core
----------------------------------------------------------------------------------------------------

--------------------------------------------------
-- nyc_eventspdcomp_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventspdcomp_core(
    EVENTID string,
    ...
    EVENTHEADERPARAMETERSEXCESSIVESPD string,
    EVENTHEADERPARAMETERSEXCESSIVESPDTIME string,
...
DROP TABLE IF EXISTS nyc_eventspdcomp_tmp;

CREATE TABLE nyc_eventspdcomp_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventspdcomp_staging;

INSERT INTO TABLE nyc_eventspdcomp_core
SELECT
    EVENTID AS EVENTID,
    ...
    EVENTHEADER.PARAMETERS.EXCESSIVESPD AS EVENTHEADERPARAMETERSEXCESSIVESPD,
    EVENTHEADER.PARAMETERS.EXCESSIVESPDTIME AS EVENTHEADERPARAMETERSEXCESSIVESPDTIME,
