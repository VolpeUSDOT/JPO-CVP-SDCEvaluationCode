...
-- Relational tables 
--   nyc_eventcspdomp_core
----------------------------------------------------------------------------------------------------

--------------------------------------------------
-- nyc_eventcspdomp_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventcspdomp_core(
    EVENTID string,
    ...
    EVENTHEADERPARAMETERSEXCESSIVECURVESPD string,
    EVENTHEADERPARAMETERSEXCESSIVECURVESPDTIME string,
    EVENTHEADERPARAMETERSMINCURVESPD string,
...
DROP TABLE IF EXISTS nyc_eventcspdomp_tmp;

CREATE TABLE nyc_eventcspdomp_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventcspdomp_staging;

INSERT INTO TABLE nyc_eventcspdomp_core
SELECT
    EVENTID AS EVENTID,
    ...
    EVENTHEADER.PARAMETERS.EXCESSIVECURVESPD AS EVENTHEADERPARAMETERSEXCESSIVECURVESPD,
    EVENTHEADER.PARAMETERS.EXCESSIVECURVESPDTIME AS EVENTHEADERPARAMETERSEXCESSIVECURVESPDTIME,
    EVENTHEADER.PARAMETERS.MINCURVESPD AS EVENTHEADERPARAMETERSMINCURVESPD,
