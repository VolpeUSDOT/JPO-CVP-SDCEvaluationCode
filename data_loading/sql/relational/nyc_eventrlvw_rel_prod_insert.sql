...
-- nyc_eventrlvw_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventrlvw_core(
    EVENTID string,
...
DROP TABLE IF EXISTS nyc_eventrlvw_tmp;

CREATE TABLE nyc_eventrlvw_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventrlvw_staging;

INSERT INTO TABLE nyc_eventrlvw_core
SELECT
    EVENTID AS EVENTID,
