...
-- nyc_eventlcw_core
--------------------------------------------------
CREATE TABLE IF NOT EXISTS nyc_eventlcw_core(
    EVENTID string,
...
DROP TABLE IF EXISTS nyc_eventlcw_tmp;

CREATE TABLE nyc_eventlcw_tmp 
STORED AS ORC tblproperties("orc.compress"="Zlib") 
AS SELECT 
    * 
FROM nyc_eventlcw_staging;

INSERT INTO TABLE nyc_eventlcw_core
SELECT
    EVENTID AS EVENTID,
